# adlc-execute Output Examples (Phases 4-6)
...
**Test matrix:** 3 target utterance variants x 4 runs, 3 regression canaries x 2 runs, bulk eval after both pass
**Max iterations:** 5
...
### Recommendation
- GO. Use `developing-agentforce` separately for deployment/publish/activation if approved.

### Artifacts
- Instruction: adlc/agents/<agent-dev-name>__<org-alias>/tickets/<TICKET-KEY>/attempts/03/instruction.txt
- Test suite: <TICKET-KEY>-invoice-compaction
- Eval report: adlc/agents/<agent-dev-name>__<org-alias>/tickets/<TICKET-KEY>/attempts/03/eval-report.html
```
