# adlc-ticket Evaluation — 15 Sample Tickets

> Training material: shows how adlc-ticket evaluates real tickets.
...
|---|---|---|
| What should change? | ✅ | Specific changes described |
| Which agent/topic? | ✅ | Agent/topic explicitly named |
| Acceptance criteria? | ✅ | Acceptance criteria present |
| Baseline reference? | ✅ | Baseline referenced |
| Before/after examples? | ✅ | Examples provided |

**⚠️ Eval impact:**
- Removes 'Here's what I found' — flips eval metric
- Changes closing line — eval metric needs update
...
|---|---|---|
| What should change? | ✅ | Specific changes described |
| Which agent/topic? | △ | Agent/topic implied but not explicit |
| Acceptance criteria? | ✅ | Acceptance criteria present |
...
If a user has a question regarding their own company website, it is not in our list of Trusted Knowledge URLs from [mention]...
...
Analysis of 30 employer support voice calls under the "Job Setting" sub-type (March 27, 2026) revealed an 80% full-resolution r...
...
|---|---|---|
| What should change? | ✅ | Specific changes described |
| Which agent/topic? | ❌ | No agent or topic specified |
| Acceptance criteria? | ✅ | Acceptance criteria present |
| Baseline reference? | ✅ | Baseline referenced |
| Before/after examples? | ✅ | Examples provided |

**Description preview:** **Context**: We want to explore how different LLM model impact both quality and latency.

**Requirements**

1. Document all the places where LLMs can ...
...
**Description preview:** **Context**: Currently we have no traceability to identify agentforce sessions from a messaging session that was escalated via Scout. This is a signif...
...
| Criteria | Score | Assessment |
|---|---|---|
| What should change? | ❌ | No specific changes or too vague |
| Which agent/topic? | △ | Agent/topic implied but not explicit |
| Acceptance criteria? | ❌ | No acceptance criteria |
| Baseline reference? | ❌ | No baseline reference |
| Before/after examples? | ❌ | No before/after examples |

**To fix:** Add: What should change?, Acceptance criteria?, Baseline reference?, Before/after examples?

**Description preview:** Continuation of [mention] we need to make sure we are being consistent with the preferred terminology of “Representative” in lieu of “Specialist” or “...
...
**Description preview:** We need consistent phrasing when we autoescalte to always be “**One moment while I transfer you to a Specialist to help with \[insert topic\].**”
