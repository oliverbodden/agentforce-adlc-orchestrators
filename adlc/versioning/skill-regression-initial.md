...
| Corporate artifact repo URL checked | Partial | URL recorded as `https://code.corp.indeed.com/telecom/it-adlc`; repo not cloned locally during Phase 0. |
...
- Installer docs need to reflect Salesforce upstream first, Indeed overlay second.
