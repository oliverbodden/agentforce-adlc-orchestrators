# Indeed Agentforce ADLC Overlay

This repo contains the Indeed/local overlay for Agentforce ADLC work: wrapper skills, local process docs, playbooks, bootstrap/status tooling, ticket guides, and artifact conventions.
...
3. Indeed/local overlay: `adlc-drive`, `adlc-execute`, `adlc-ticket`, overlay docs, playbooks, and artifact workflow.
